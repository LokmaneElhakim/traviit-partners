...
const Timeline: React.FC = () => {
  ...
  const steps =
    activeTab === "seeker"
      ? [
          {
            title: t("timeline.seeker.step1.title"),
            desc: t("timeline.seeker.step1.desc"),
            icon: "edit_note",
          },
          {
            title: t("timeline.seeker.step2.title"),
            desc: t("timeline.seeker.step2.desc"),
            icon: "dashboard_customize",
          },
          {
            title: t("timeline.seeker.step3.title"),
            desc: t("timeline.seeker.step3.desc"),
            icon: "download",
          },
        ]
      : [
          {
            title: t("timeline.recruiter.step1.title"),
            desc: t("timeline.recruiter.step1.desc"),
            icon: "filter_alt",
          },
          {
            title: t("timeline.recruiter.step2.title"),
            desc: t("timeline.recruiter.step2.desc"),
            icon: "manage_accounts",
          },
          {
            title: t("timeline.recruiter.step3.title"),
            desc: t("timeline.recruiter.step3.desc"),
            icon: "description",
          },
        ];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h3 className="mt-8 text-xl font-bold text-gray-900 dark:text-white">
            {activeTab === "seeker"
              ? t("timeline.seeker.title")
              : t("timeline.recruiter.title")}
          </h3>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="space-y-12 md:space-y-24">
            {steps.map((step, idx) => (
              ...
              >
                {/* Mobile card */}
                <div className="md:hidden w-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 p-6 rounded-2xl shadow-sm">
                ...
                <div
                  className={`hidden md:block md:w-[42%] ${idx % 2 !== 0 ? "hidden md:block" : ""} ${idx % 2 === 0 ? "bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 p-6 rounded-2xl md:text-end hover:shadow-lg dark:hover:bg-white/[0.08] transition-all relative group shadow-sm animate-fadeIn" : ""}`}
                >
                  {idx % 2 === 0 && (
                    <>
                ...
                <div className="relative z-10 w-12 h-12 rounded-full bg-white dark:bg-deep-navy border-4 border-electric-blue hidden md:flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.5)] transform transition-transform hover:scale-110">
                ...
                <div
                  className={`hidden md:block md:w-[42%] ${idx % 2 === 0 ? "hidden md:block" : ""} ${idx % 2 !== 0 ? "bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 p-6 rounded-2xl hover:shadow-lg dark:hover:bg-white/[0.08] transition-all relative group shadow-sm animate-fadeIn" : ""}`}
                >
                  {idx % 2 !== 0 && (
                    <>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-electric-blue transition-colors">
