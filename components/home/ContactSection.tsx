              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600 dark:text-gray-400">
                    <a
                      href="mailto:traviitchannel@gmail.com"
                      className="hover:text-electric-blue transition-colors"
                    >
                      traviitchannel@gmail.com
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-electric-blue outline-none transition-all"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-2">
